...
\reportsubtitle{Plain-language explanation of the changes: 26H-ECL-GA-CASE4B}
...
\noindent\textbf{Document ID:} 26H-ECL-GA-CASE4B\\
\meetingline\\
\textbf{Companion to:} the full proposed New Bylaws text, 26H-ECL-GA-CASE4A, and the voting procedure, 26H-ECL-GA-CASE4C. This document has no independent legal effect: if it conflicts with 26H-ECL-GA-CASE4A, the full text controls.
...
\textbf{3. Election and Control Committee.} A new three-member committee, elected each autumn, takes over running elections and advance nominations, and monitors Bylaw compliance: work currently done informally by the Board itself. The committee is first elected at a Supplementary General Assembly after the new C-suite takes office. This General Assembly's own election uses the Old Bylaws' election mechanics (see Case 6).
...
\textbf{9. Higher bar for future Bylaw Amendments.} Under the Old Bylaws, a future Bylaw Amendment needs 2/3 of all members to vote in favour, however few attend. Under the New Bylaws (\S17.1), a future Bylaw Amendment needs both: 2/3 of all members physically present at the General Assembly at the time of the vote, \emph{and} 2/3 of those present voting in favour. This makes the Association's own constitution harder to change on a thin turnout, either way.

\textbf{10. Digital record-keeping.} A new clause (\S14.11) requires every document of the Association, including agreements signed on paper, to also be kept digitally. A paper signature no longer excuses a document from digital archiving.
...
Adopting the New Bylaws is a single constitutional decision requiring 2/3 of \emph{all} Eclipse NMBU members (not just those present) to vote in favour: see 26H-ECL-GA-CASE4C for exactly how that vote is structured alongside any submitted Amendments to this text.
