...
\textbf{3. Election and Control Committee.} A new three-member committee, elected each autumn, takes over running elections and advance nominations, and monitors Bylaw compliance: work currently done informally by the Board itself. \textbf{This committee does not exist yet}; it will only exist after these New Bylaws are adopted and the committee is elected at a future Supplementary General Assembly. This General Assembly's own election therefore still uses the Old Bylaws' election mechanics (see the Transitional C-suite Case, ECL-H2026-CASE-08).

\textbf{4. Two General Assemblies a year, with different jobs.} The New Bylaws formally distinguish a spring \textbf{Elective General Assembly} (full Board elections) from an autumn \textbf{Supplementary General Assembly} (fills vacancies, elects the Election and Control Committee). The Old Bylaws did not distinguish these: every General Assembly did full elections. \emph{This General Assembly is being held under the Old Bylaws, so this distinction does not change how today's election works; it only governs future General Assemblies once the New Bylaws are in force.}
...
\textbf{6. Project gates.} Starting a project now formally requires an MCR (Mission Concept Review) and an SRR (System Requirements Review) before the Board approves it, following a modified NASA Project Life Cycle. \emph{The detailed phase model: and any further gates such as PDR/CDR: is left to a separate governance document that has not yet been written; the Bylaws only fix MCR and SRR as mandatory today.}
