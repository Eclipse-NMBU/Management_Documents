...
Case 8 is presented on ECL-H2026-CASE-08A if the Bylaw Amendment was adopted under Case 7, and on ECL-H2026-CASE-08B if it was not. No separate vote is required, since the roles follow automatically from the result of Case 7; it is simply recorded in the Meeting Protocol, and voted on only if an Amendment has been submitted against it.
