...
all signals are done by showing your vote number, and a fingure gesture. inlegg is 1 finger up and number in portrait, respikk is 2 fingers and the voting plaket in landskape. after a replikk the original inlegsholder can show 3 fingers to th eordstyrer to indekate thay want a svar replik. makig a questionmark (bent finger) and the coting balet in protrait is "saksoplysning"
