...
Before anything else can happen, the meeting has to ``constitute'' itself: elect someone to chair the meeting (Meeting Chair), someone to take minutes (Secretary), two people to count votes (Vote Counters), and two people to check and sign the final minutes (Protocol Signers). Nothing else can be validly decided until this is done. Right after that, the meeting approves the Notice and the Agenda (Cases 2 and 3).

\vsection{The Agenda}
The Agenda (saksliste) is the running order for the meeting -- the list of everything that will be discussed and voted on, in order. This meeting has ten Cases, numbered 1 to 10. You can find it as ECL-H2026-AGD-01, and the Overview (ECL-H2026-OVW-01) lists every document you might be handed.
...
An Amendment (endringsforslag) is a proposed change to a Case that's already on the Agenda. You write down exactly what you want changed and what you want it changed to, and submit it in writing before voting on Cases begins. Full details are in the Amendment Submission Procedure, ECL-H2026-PROC-01. \textbf{Once voting on Cases has started, no new Amendments can be submitted} -- there's no last-minute exception.
